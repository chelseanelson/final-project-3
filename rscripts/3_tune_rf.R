...
# autoplot
rf_plot <- autoplot(tuned_rf, metric = "roc_auc")

# write out results (fitted/trained workflows)
save(tuned_rf, tictoc_rf, file = here("results/fitted_tuned_models/tuned_rf.rda"))
ggsave(rf_plot, file = here("images/plots/rf_plot.png"))